...
export const birthdayThen = [
    ...
    'сбудутся твои мечты, Пусть окунёшься в счастье ты, Пусть будет ярким настроенье! Будь с позитивом! С днём Бана!',
]
